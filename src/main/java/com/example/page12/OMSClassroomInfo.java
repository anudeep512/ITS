...
public class OMSClassroomInfo {
    ...
    public void setIithId(String iithId) {
        OMSClassroomInfo.iithId = iithId;
    }
    ...
    public void ObjListView(ActionEvent event) throws IOException {
        root = FXMLLoader.load(requireNonNull(getClass().getResource("OMSClassroomObjectsList.fxml")));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    ...
    public void SVTableView(ActionEvent event) throws IOException {
        root = FXMLLoader.load(requireNonNull(getClass().getResource("OMSClassroomSVTable.fxml")));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        OMSClassroomSVTableController omsClassroomSVTableController = new OMSClassroomSVTableController();
        omsClassroomSVTableController.setIithId(iithId);
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    }
    ...
    public void add(ActionEvent event) throws IOException {
        root = FXMLLoader.load(requireNonNull(getClass().getResource("OMSClassroomAddObjectType.fxml")));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        OMChangePasswordPageController omChangePasswordPageController = new OMChangePasswordPageController();
        omChangePasswordPageController.setIithId(iithId);
        scene = new Scene(root);
