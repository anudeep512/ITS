...
public class OMSLibraryInfoController {

    static String iithId ;
    public void setIithId(String iithId) {
        OMSLibraryInfoController.iithId = iithId;
    }
    ...
    public void ObjListView(ActionEvent event) throws IOException {
        root = FXMLLoader.load(requireNonNull(getClass().getResource("OMSLibraryObjectsList.fxml")));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    ...
    public void SVTableView(ActionEvent event) throws IOException {
        root = FXMLLoader.load(requireNonNull(getClass().getResource("OMSLibrarySVTable.fxml")));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        OMSLibrarySVTableController omsLibrarySVTableController = new OMSLibrarySVTableController();
        omsLibrarySVTableController.setIithId(iithId);
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    }
    ...
    public void add(ActionEvent event) throws IOException {
        root = FXMLLoader.load(requireNonNull(getClass().getResource("OMSLibraryAddObjectType.fxml")));
        stage = (Stage)((Node)event.getSource()).getScene().getWindow();
        OMChangePasswordPageController omChangePasswordPageController = new OMChangePasswordPageController();
        omChangePasswordPageController.setIithId(iithId);
        scene = new Scene(root);
